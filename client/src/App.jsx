...
export default function App() {
  ...
  const pickMovie = useCallback(
    ...
    [movieGenres, movieRatings, movieFormats, movieYearFrom, movieYearTo]
  );
  ...
  const pickTv = useCallback(
    ...
    [tvGenres, tvRatings, tvFormats, tvYearFrom, tvYearTo]
  );
      ...
      {view === 'movieFilters' && movieFilters && (
        <>
          <FilterPanel
            ...
            yearTo={movieYearTo}
            onToggleGenre={(g) => toggle(setMovieGenres, g)}
      ...
      {view === 'tvFilters' && tvFilters && (
        <>
          <FilterPanel
            ...
            yearFrom={tvYearFrom}
            yearTo={tvYearTo}
            onToggleGenre={(g) => toggle(setTvGenres, g)}
